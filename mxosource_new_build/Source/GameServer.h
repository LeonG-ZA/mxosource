...
public:
	...
	bool Start( WorldModel* NewWorldModel , ReceiveRequestRPC* NewRequestRPC , HandleResponseRPC* NewResponseRPC );
	void Stop();
	void Loop();
	...
	WorldModel* GetWorldModel ( void ) { return MyWorldModel ; }
	ReceiveRequestRPC* GetRPCBuffer ( void ) { return MyRequestRPC ; }

	ResponseHandler* GetResponseHandler ( void ) { return MyResponseHandler ; }
...
private:	
	...
	ReceiveRequestRPC* MyRequestRPC ;
	HandleResponseRPC* MyResponseRPC ;
