...
public:
	...
	bool CreateCharacter(const string& worldName, const string& userName, const string& charHandle, const string& firstName, const string& lastName, const string& rank);
	void SetItemCash( const string& itemId, const string& price );
	void SetProcedureAdmin( const string& value );
	void UpdateMissionSystem();
	void UpdateNPCSystem();
	void UpdateClothSystem();
	void SetLimitAreaChat( const string& value );
	void REBOOTMESSAGE();
private:
