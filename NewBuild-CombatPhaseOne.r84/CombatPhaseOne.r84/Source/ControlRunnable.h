...
{
public:
	ControlRunnable ( HandleRequestRPC* NewRequestRPC , ProduceResponseRPC* NewResponseRPC , WorldModel* NewWorldModel )
	{
		MyControlServer = new ControlServer ( NewWorldModel , NewRequestRPC , NewResponseRPC ) ;
	}
	~ControlRunnable ()
	{
