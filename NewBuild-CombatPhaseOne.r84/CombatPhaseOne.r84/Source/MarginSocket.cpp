	...
	case MS_LoadCharacterRequest:
		{
			...
			//scope for db ptr
			{
				WorldModel* myModel = sMargin.GetWorldModel () ;

				PlayerCharacterModel* myPlayerCharacterModel = myModel->AddPlayerCharacter ( m_userId , charId ) ;

				m_charName = myPlayerCharacterModel->GetHandle () ;
				m_firstName = myPlayerCharacterModel->GetFirstName () ;
				m_lastName = myPlayerCharacterModel->GetLastName () ;

				m_background = myPlayerCharacterModel->GetBackground () ;
			}
			...
			unsigned char packet8[] =
			{
				...
				0x10, 0x00, 0x8c, 0x01, // -> length packet (important)
				...
				0x29, 0x00, 0x32, 0x30, 0x04, 0x80, //SwirlingKiSummonAbility
				0x2a, 0x00, 0x32, 0x2c, 0x04, 0x80, //SkyHighSidekickAbility
				0x2b, 0x00, 0x32, 0x58, 0x08, 0x80, //WristThrowAbility
				0x2c, 0x00, 0x32, 0x60, 0x08, 0x80, //KiChargedFootSweepAbility

				/*
				0x2d, 0x00, 0x32, 0xb4, 0x00, 0x80, //ExecuteProgramAbility
				0x2e, 0x00, 0x32, 0xb8, 0x0f, 0x80, //HackerCombatStyleAbility
				0x2f, 0x00, 0x00, 0xE4, 0x00, 0x80, //LogicBarrageAbility
				0x30, 0x00, 0x32, 0xb0, 0x00, 0x80, //DownloadMissionMapAbility
				*/

				0x31, 0x00, 0x32, 0x94, 0x01, 0x80, //AikidoAbility
				0x32, 0x00, 0x32, 0x34, 0x04, 0x80, //AikidoMasteryAbility
				0x33, 0x00, 0x32, 0x38, 0x04, 0x80, //AikidoMasterAbility
				0x34, 0x00, 0x00, 0x40, 0x04, 0x80, //SereneCalmAbility
				0x35, 0x00, 0x00, 0x48, 0x04, 0x80, //MakiOtoshiAbility
				0x36, 0x00, 0x00, 0x3c, 0x04, 0x80, //IronBodyAbility
				0x37, 0x00, 0x00, 0x44, 0x04, 0x80, //CounterThrowAbility

				0x38, 0x00, 0x32, 0x54, 0x06, 0x80, //AikidoRedirectionAbility
				0x39, 0x00, 0x00, 0x5c, 0x06, 0x80, //PunchReversalAbility
				0x3a, 0x00, 0x00, 0x70, 0x06, 0x80, //TomoNageAbility
				0x3b, 0x00, 0x00, 0x58, 0x06, 0x80, //KiBurstAbility
				0x3c, 0x00, 0x00, 0x6c, 0x06, 0x80, //AerialTakedownAbility

				0x3d, 0x00, 0x32, 0xf4, 0x01, 0x80, //FirearmsExpertAbility
				0x3e, 0x00, 0x32, 0x04, 0x02, 0x80, //HandgunsAbility

				0x40, 0x00, 0x32, 0xbc, 0x03, 0x80, //DualHandgunsAbility
				0x41, 0x00, 0x00, 0xcc, 0x03, 0x80, //PistolAerialAbility
				0x42, 0x00, 0x00, 0xd0, 0x03, 0x80, //PistolBarrageAbility
				0x43, 0x00, 0x00, 0xc4, 0x03, 0x80, //PistolSlideAbility
				0x44, 0x00, 0x00, 0xc8, 0x03, 0x80, //PistolEvasiveAbility

				/*
				//0x45, 0x00, 0x00, 0x14, 0x05, 0x80, //RestoreRSIAbility
				0x45, 0x00, 0x32, 0xd0, 0x00, 0x80, //HackerAbility

				0x46, 0x00, 0x32, 0x1c, 0x01, 0x80, //RepairAndUpgradeAbility
				0x47, 0x00, 0x00, 0x34, 0x01, 0x80, //RepainRSIAbility
				0x48, 0x00, 0x00, 0x40, 0x01, 0x80, //RestoreHealth1Ability
				0x49, 0x00, 0x00, 0xd4, 0x00, 0x80, //HarmfulCodeAbility
				*/

				0x45, 0x00, 0x32, 0x94, 0x00, 0x80, //WriteCodeAbility
				0x46, 0x00, 0x00, 0x6c, 0x00, 0x80, //RemoteProxy1Ability
